...
export async function InternationalPartnersPreview() {
  const t = await getTranslations("home.partnersPreview");
  ...
  return (
    <section className="border-y border-brand-border bg-brand-surface px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <FadeIn>
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-5 font-display text-4xl text-brand-frost sm:text-5xl">
                {t("title")}
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-brand-muted">{t("subtitle")}</p>
            </div>
            <Link
              href="/about"
        ...
        <div className="mt-12">
          <FadeIn delay={0.03}>
            <ImageStrip startIndex={8} count={6} />
          </FadeIn>
        </div>
        <div className="mt-14 grid gap-8 lg:grid-cols-3">
          ...
          <FadeIn delay={0.1}>
            <div className="rounded-2xl border border-brand-border bg-brand-base/50 p-6 shadow-sm">
              ...
              <p className="mt-4 text-sm leading-relaxed text-brand-muted">{t("regionsBody")}</p>
          ...
          <FadeIn delay={0.15}>
            <div className="rounded-2xl border border-brand-border bg-brand-base/50 p-6 shadow-sm">
              ...
              <p className="mt-4 text-sm leading-relaxed text-brand-muted">{t("tournamentsBody")}</p>
              <ul className="mt-4 space-y-2 text-sm font-medium text-brand-ink">
